...
import com.example.dicodingevent.databinding.ItemSearchBinding

class SearchBarAdapter : ListAdapter<ListEventsItem, SearchBarAdapter.MyViewHolder>(DIFF_CALLBACK) {
